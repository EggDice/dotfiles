...
defaults write NSGlobalDomain AppleLanguages -array "en" "hu" "pt"
...
# Disable default Spotlight shortcuts
...
# Set Option + P for "Show Spotlight search"
defaults write com.apple.symbolichotkeys AppleSymbolicHotKeys -dict-add 64 "{enabled = 1; value = { parameters = (112, 33, 524288); type = 'standard'; }; }"
